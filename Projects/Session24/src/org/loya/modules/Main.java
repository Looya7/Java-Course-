...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        llegadas.sort((a,b)->a.getFecha().compareTo(b.getFecha()));
        for(Vuelo ordenado : llegadas){
            System.out.println(ordenado);
        }
        Vuelo ultimo = llegadas.get(llegadas.size()-1);
        System.out.println("El último vuelo fue "+ultimo.getNombre()+" el "+ultimo.getFecha());

        llegadas.sort((a,b)->a.getCantpasajeros().compareTo(b.getCantpasajeros()));
        Vuelo menorPasajeros = llegadas.get(0);
        System.out.println("El vuelo con menor pasajeros fue "+menorPasajeros.getNombre()+" con "+menorPasajeros.getCantpasajeros()+ " pasajeros");
